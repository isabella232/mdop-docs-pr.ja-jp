...
-   [<span data-ttu-id="857cb-157">レビュー担当者タスクの実行</span><span class="sxs-lookup"><span data-stu-id="857cb-157">Performing Reviewer Tasks</span></span>](performing-reviewer-tasks-agpm40.md)
