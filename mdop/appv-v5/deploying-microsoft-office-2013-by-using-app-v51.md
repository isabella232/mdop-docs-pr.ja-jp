...
この記事の情報は、Microsoft Application Virtualization (App-v) 5.1 以降のバージョンを使用して、Microsoft Office 2013 を仮想化されたアプリケーションとして組織内のコンピューターに配信するために使用します。 Office 2010 を提供するために app-v を使用する方法については、「 [App-v を使用して Microsoft Office 2010 を展開](deploying-microsoft-office-2010-by-using-app-v51.md)する」を参照してください。 App-v を使用して Office 2013 を正常に展開するには、Office 2013 とアプリについて理解している必要があります。
...
<tbody>
<tr class="odd">
<td align="left"><p><a href="planning-for-using-app-v-with-office51.md#bkmk-office-vers-supp-appv" data-raw-source="[Planning for Using App-V with Office](planning-for-using-app-v-with-office51.md#bkmk-office-vers-supp-appv)">APP-V で Office を使用するための計画</a></p></td>
<td align="left"><ul>
...
<tr class="even">
<td align="left"><p><a href="planning-for-using-app-v-with-office51.md#bkmk-plan-coexisting" data-raw-source="[Planning for Using App-V with Office](planning-for-using-app-v-with-office51.md#bkmk-plan-coexisting)">APP-V で Office を使用するための計画</a></p></td>
...
次の手順を実行して、App-v 5.1 以降の Office 2013 パッケージを作成します。

**重要**  
App-v 5.1 以降では、Office 展開ツールを使用してパッケージを作成する必要があります。 Sequencer を使ってパッケージを作成することはできません。
...
<td align="left"><ul>
<li><p>64ビット版の Windows 8 以降</p></li>
...
64ビットの Windows コンピューター上で Office 2013 App-v パッケージを作成します。 作成された Office 2013 App-v パッケージは、32ビットおよび64ビットの Windows 7、Windows 8.1、Windows 10 のコンピューターで実行されます。
...
-   64ビットの Windows コンピューター上で Office 2013 App-v パッケージを作成します。 ただし、パッケージは、32ビットおよび64ビットの Windows 7、Windows 8、Windows 10 のコンピューターで実行されます。
...
## <a href="" id="bkmk-pub-pkg-office"></a>Office パッケージを App-v で公開する-V 5.1
...
2.  App-v 5.1 Sequencer を使って、プラグインの順序を作成します。 プラグインの順序を示すために使用されているコンピューターに Office 2013 がインストールされていることを確認します。 Office 2013 プラグインをシーケンス処理するときは、シーケンスコンピューターで Microsoft 365 アプリを使用することをお勧めします。

3.  目的のプラグインを含む App-v 5.1 パッケージを作成します。
