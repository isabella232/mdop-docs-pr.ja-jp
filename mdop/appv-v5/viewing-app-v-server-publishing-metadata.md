...
-   [公開メタデータを表示するための app-v 5.0 SP3 の要件](#bkmk-50sp3-reqs-pub-meta)
...
## <a href="" id="bkmk-50sp3-reqs-pub-meta"></a>公開メタデータを表示するための app-v 5.0 SP3 の要件
...
<div class="alert">
<strong>注</strong><br/><p><strong>ClientVersion </strong> と <strong> clientos </strong> は、app-v 5.0 SP3 でのみサポートされます。</p>
</div>
<div>

</div></td>
<td align="left"><p>App-V 5.0 SP3 の情報を参照してください。</p></td>
