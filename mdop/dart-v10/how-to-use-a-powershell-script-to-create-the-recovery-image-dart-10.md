...
ms.locfileid: "10822814"
---
# <span data-ttu-id="c747a-103">PowerShell スクリプトを使用して回復イメージを作成する方法</span><span class="sxs-lookup"><span data-stu-id="c747a-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="c747a-104">PowerShell スクリプトを使用して DaRT 回復イメージを作成するには</span><span class="sxs-lookup"><span data-stu-id="c747a-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="c747a-105">Microsoft 診断/回復ツールセット (DaRT) 10 回復イメージは、DaRT 10 の回復イメージウィザードを使用する代わりに、PowerShell スクリプトを使用して作成できます。</span><span class="sxs-lookup"><span data-stu-id="c747a-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 10 recovery image by using a PowerShell script instead of using the DaRT 10 Recovery Image wizard.</span></span> <span data-ttu-id="c747a-106">次のスクリプトの例を参照してください。</span><span class="sxs-lookup"><span data-stu-id="c747a-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="c747a-107">私</span><span class="sxs-lookup"><span data-stu-id="c747a-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="c747a-108">関連トピック</span><span class="sxs-lookup"><span data-stu-id="c747a-108">Related topics</span></span>


[<span data-ttu-id="c747a-109">PowerShell を使用した DaRT 10 の管理</span><span class="sxs-lookup"><span data-stu-id="c747a-109">Administering DaRT 10 Using PowerShell</span></span>](administering-dart-10-using-powershell.md)
