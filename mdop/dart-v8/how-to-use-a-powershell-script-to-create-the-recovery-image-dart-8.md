---
title: PowerShell スクリプトを使用して回復イメージを作成する方法
description: PowerShell スクリプトを使用して回復イメージを作成する方法
author: dansimp
...
ms.locfileid: "10822887"
---
# <span data-ttu-id="9c07e-103">PowerShell スクリプトを使用して回復イメージを作成する方法</span><span class="sxs-lookup"><span data-stu-id="9c07e-103">How to Use a PowerShell Script to Create the Recovery Image</span></span>


## <a href="" id="bkmk-create-image-use-script"></a><span data-ttu-id="9c07e-104">PowerShell スクリプトを使用して DaRT 回復イメージを作成するには</span><span class="sxs-lookup"><span data-stu-id="9c07e-104">To create the DaRT recovery image by using a PowerShell script</span></span>


<span data-ttu-id="9c07e-105">Microsoft 診断/回復ツールセット (DaRT) 8.0 回復イメージは、DaRT 8.0 回復イメージウィザードを使用する代わりに、PowerShell スクリプトを使用して作成できます。</span><span class="sxs-lookup"><span data-stu-id="9c07e-105">You can create the Microsoft Diagnostics and Recovery Toolset (DaRT) 8.0 recovery image by using a PowerShell script instead of using the DaRT 8.0 Recovery Image wizard.</span></span> <span data-ttu-id="9c07e-106">次のスクリプトの例を参照してください。</span><span class="sxs-lookup"><span data-stu-id="9c07e-106">See the following example script.</span></span>
...
`Import-Module "Dism"`<span data-ttu-id="9c07e-107">私</span><span class="sxs-lookup"><span data-stu-id="9c07e-107">I</span></span>`mport-Module "Microsoft.Dart"`
...
## <span data-ttu-id="9c07e-108">関連トピック</span><span class="sxs-lookup"><span data-stu-id="9c07e-108">Related topics</span></span>


[<span data-ttu-id="9c07e-109">PowerShell を使用した DaRT 8.0 の管理</span><span class="sxs-lookup"><span data-stu-id="9c07e-109">Administering DaRT 8.0 Using PowerShell</span></span>](administering-dart-80-using-powershell-dart-8.md)
