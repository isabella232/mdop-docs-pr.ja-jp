...
---
# PowerShell スクリプトを使用して回復イメージを作成する方法


## <a href="" id="bkmk-create-image-use-script"></a>PowerShell スクリプトを使用して DaRT 回復イメージを作成するには


Microsoft 診断/回復ツールセット (DaRT) 8.0 回復イメージは、DaRT 8.0 回復イメージウィザードを使用する代わりに、PowerShell スクリプトを使用して作成できます。 次のスクリプトの例を参照してください。
...
`Import-Module "Dism"`私`mport-Module "Microsoft.Dart"`
